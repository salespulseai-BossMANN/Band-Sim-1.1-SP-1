...
String[] songsRepertoire = {"Rock it, and Roll it","Electric boggaloo", "Hey Code","Die, PopPop",};
            ...
            int sheetSongRepertoire = songsRepertoire.length;//
        String sheetLine = "-------------------------------";
...
void main() {
    ...
    System.out.println(sheetRepertoire + " (" + sheetSongRepertoire+ " Songs)");
    System.out.println();
    System.out.println();
    System.out.println();
...
System.out.println("Song "+(i+1));
                ...
                System.out.println(songsRepertoire[(i % sheetSongRepertoire)]);
                     System.out.println();
